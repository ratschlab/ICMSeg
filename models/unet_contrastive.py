...
from models.basic_segmentation_contrastive import BasicSegmentationContrastModel
...
class UNet(BasicSegmentationContrastModel):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:        
        ...
        return logits, self.projection_head(x5)
